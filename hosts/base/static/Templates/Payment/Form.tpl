...
<div class="b-table b-table_wide b-form__table">
    <div class="b-table__tr">
        <div class="b-table__tr__td b-form__table_head b-form__table_head_active"><div class="b-form__title"><a href="/profile#payment" class="b-form__table_head__action">Продление услуги</a></div></div>
        <div class="b-table__tr__td b-form__table_head"><div class="b-form__title"><a href="/profile#history" class="b-form__table_head__action">История платежей</a></div></div>
    </div>
</div>
<div class="b-table b-table_wide b-form__table">
    <div class="b-table__tr">
